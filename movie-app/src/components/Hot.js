...
export default function Hot(props)
{
   ...
   {
      if (props.movies[i].year == '2020' || props.movies[i].year == '2021' || props.movies[i].year == '2022')
      {
         hot.push(props.movies[i])
         continue
      }
   }
   return (
      <div className={classes.root}>
         ...
         <div className={classes.header_holder}><Header className={classes.header_page}>Hot Right Now!   'Films from the last 3 years.'</Header></div>
