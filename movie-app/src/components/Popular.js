...
export default function Popular(props)
{
   ...
   {
      if (props.movies[i].rating >= 4)
      {
         popular.push(props.movies[i])
         continue
      }
   }
   return (
      <div className={classes.root}>
         ...
         <div className={classes.header_holder}><Header className={classes.header_page}>Popular - Films rated 4 stars or above.</Header></div>
