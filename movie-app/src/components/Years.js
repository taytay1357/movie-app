...
export default function Years(props)
{
   ...
   {
      if (props.movies[i].year == year)
      {
         years.push(props.movies[i])
         continue
      }
   }
   return (
      <div className={classes.root}>
         ...
         <div className={classes.header_holder}><Header className={classes.header_page}>Films in the year '{year}' - {years.length} results.</Header></div>
